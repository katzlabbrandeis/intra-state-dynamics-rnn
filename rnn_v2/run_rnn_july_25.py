...
from train import MSELoss, smooth_MSELoss, train_model
            ...
            try:
                ...
                if pred_firing_long.shape[1] == pca_obj.n_components_:
                    ...
                    if pred_firing_long.shape[1] == scaler.mean_.shape[0]:
                        ...
                        print(
                            f"[INFO] Skipping scaler inverse: shape {pred_firing_long.shape[1]} ≠ scaler mean dim {scaler.mean_.shape[0]}")
